...
begin
	...
	@variables θ(t)
	@parameters m =0.1 L=0.15 g=9.81 Ω =2.0
	...
	lagrangian_T = 0.5 * m * L^2 * ((D(θ)^2) + (Ω^2 * sin(θ)^2))
...
begin
	...
	function rot_pendulum!(du,u, params, t)
	    ...
	    du[2] = (omega_frame^2)*cos(θ)*(sin(θ)) - (gravity_accel/length_pendulum)*sin(θ)
	end
	omega_frame_slow = 1
	omega_frame_fast = 10 
	uθ = [0.1, 0.0] 
...
begin
	gr() 
	omega = omega_frame_fast # or omega_frame_slow
...
# ╔═╡ f4f994a9-279a-4418-90c3-483d42fd4a88
