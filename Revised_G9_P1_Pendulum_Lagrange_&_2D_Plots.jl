...
md"""
Defined Lagrange, T, and V using the pendulum frame system:

$L = T - V$

where

$T = \frac{1}{2}mL^2\dot{\theta}^2+\frac{1}{2}m\omega^2(w+L\sin\theta)^2$
...
begin 
	@variables θ̈
	Dt = Differential(t)
	eq_display = θ̈ ~ simplify(ode_symbolic)
end
...
begin
	...
	simulation_time_span = (0.0, pi)  # seconds
...
begin
	...
	time_grid = range(0, π; length = 800)
	...
	solution_slow = solve(problem_slow, saveat = time_grid)
	...
	solution_fast = solve(problem_fast, saveat = time_grid)
end

# ╔═╡ 17f0e32d-f0ce-4339-9768-ccecf115e191
...
manifest_format = "2.0"
project_hash = "fb2b937e66e73a8275c226af88033b8cfecd6d9c"
...
git-tree-sha1 = "c98d9dcbc64b80e246a47d190891c382a221b52e"
...
git-tree-sha1 = "9b272562628fa23648ac4d144dee2925fa9459be"
...
git-tree-sha1 = "1cf184eec17c2466ef3015f47c02fe1fbeee4f6a"
...
git-tree-sha1 = "e633692849e7e226d16e495e214057fcbe902d4b"
...
git-tree-sha1 = "733200f6b48ee91261cceefdc9237815dc782ee3"
